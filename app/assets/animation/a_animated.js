...
const SVGatorComponent = React.forwardRef((props, ref) => {
    ...
    return (
        <WebView
            ...
            style={{"backgroundColor": "transparent", "flex": 0, "height": 120, "width": "100%"}}
        />
    );
});
